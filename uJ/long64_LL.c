...
UInt64 u64_32_to_64(UInt32 v) { return (UInt64)v; }

UInt32 u64_64_to_32(UInt64 v) { return (UInt32)v; }

UInt32 u64_get_hi(UInt64 v) { return (UInt32)(v >> 32ULL); }

UInt64 u64_add(UInt64 a, UInt64 b) { return a + b; }

UInt64 u64_add32(UInt64 a, UInt32 b) { return a + (UInt64)b; }

UInt64 u64_mul(UInt64 a, UInt64 b) { return a * b; }

UInt64 u64_umul3232(UInt32 a,
                    UInt32 b) // sad but true: gcc has no u32xu32->64 multiply
{
    return ((UInt64)a) * ((UInt64)b);
}

UInt64 u64_smul3232(Int32 a,
                    Int32 b) // sad but true: gcc has no s32xs32->64 multiply
{
...
Boolean u64_isZero(UInt64 a) { return a == 0; }

Boolean i64_isNeg(Int64 a) { return ((Int64)a) < 0; }
